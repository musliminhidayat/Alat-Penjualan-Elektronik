...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Jan 2022 pada 06.23
...
INSERT INTO `tabel_pegawai` (`id_pegawai`, `nama_pegawai`, `jabatan`) VALUES
(387, 'tayo', 'meneger'),
(987, 'hmzt', 'kasir');
...
INSERT INTO `tabel_penjualan` (`id_penjualan`, `id_barang`, `nama_pembeli`, `nomor_pembeli`, `alamat_pembeli`, `jumlah_pesanan`, `total_harga`, `tanggal_pesanan`, `id_pegawai`) VALUES
(1, '99', 'zi', '09', 'pwt', 9, 80000000, '2022-01-12', 2213),
(2, '0006', 'a', '01245', 'terserah', 5, 154000, '2022-01-12', 3330),
(9, '99', 'zi', '09', 'pwt', 9, 80000000, '2022-01-11', 2213),
(12, '0006', 'a', '01245', 'terserah', 5, 154000, '2022-01-12', 3330),
(49, '75', 'hjv', '8999', 'gvhg', 908989, 87687667, '2022-01-09', 0),
(76, 'fdx', 'tdsgfq', '757', 'gfdf', 65461, 654, '2022-01-09', 0);
